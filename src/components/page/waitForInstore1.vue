    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
                ...
                <el-input style="width:160px;" v-model="case_number" placeholder="案卷号查询"></el-input>
                <!-- 关键词联想组建 -->
                <el-select
                  v-model="case_name"
                ...
                <el-select v-model="anguan_pingcha_chaoqi" style="width: 160px;margin-left: 30px;" placeholder="评查是否超期">
                  <el-option
        ...
        <el-dialog
          ...
          <div class="steps">
            <el-steps :active="0" align-center direction="vertical" space="80px">
              <el-step :status="bjrq==null?'wait':'finish'" title="" description="">
                <template slot="title">是否办结：{{bjrq==null?"未办结":"已办结"}}</template>
                <template v-if="bjrq==null?false:true" slot="description">时间：{{bjrq}}</template>
              </el-step>
          ...
          getNumBage(){
                ...
                self.$axios({
                    ...
                    if(data.data.code==0){
                       ...
                       self.$children[14].$children[0].$forceUpdate();
                       // self.$forceUpdate()
                    }else{
                      self.$response(data,self);
                    }
