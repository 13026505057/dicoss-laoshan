...
<!--         <div >
        ...
        <div id="container" style="width: 100%;height: 110%;  float: right;">
          <div class="numData">
            ...
            <div class="tableTitle">
              <el-button type="primary" @click="showAddNew">新增打印机</el-button>
            </div>
          </div>
            <el-dialog title="新增打印机" :visible.sync="dialogFormVisible">
              <el-form :model="form">
                <el-form-item label="打印机名称:" label-width="120px">
                  <el-input v-model="form.print_name" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
                <el-form-item label="打印机编号:" label-width="120px">
                  <el-input v-model="form.print_code" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
              </el-form>
            ...
            <el-dialog title="修改资料" :visible.sync="dialogFormVisible2">
              <el-form :model="form">
                ...
                <el-form-item label="单位编号:" label-width="120px">
                  <el-input v-model="form.org_code" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
              </el-form>
              <div slot="footer" class="dialog-footer">
          ...
          <div class="tableList">
                ...
                <el-form style="margin-top:100px;margin-left:30%;" :model="form">
                    <el-form-item label="选择打印机:" label-width="130px">
                        <el-select v-model="printId" placeholder="选择打印机">
                            <el-option
  ...
  export default {
      data: function(){
          return {
              ...
              pageSize:10,
              total:10,
              printId:localStorage.getItem('printId'),
              name:'',
              restaurants: [],
              value1:'',
              value2:'',
      ...
      methods: {
          ...
          saveClick(){
            var self = this;
            localStorage.setItem('printId',self.printId);
            self.$message({
                type: 'success',
                message: '保存成功!'
            });
          ...
          upData(data){
                ...
                params.append('org_code',self.form.org_code);
          ...
          addNew(){
                ...
                var params = new URLSearchParams();
                var token = localStorage.getItem('auth');
                params.append('print_name',self.form.print_name);  
                params.append('print_id',self.form.print_code); 
                // params.append('org_level',self.form.org_code); 
                // params.append('up_org_id',self.form.org_code);
                self.$axios({
                    method: 'post',
                    url: '/orgPrintAdd',
                    data: params,
