<template>
    <div>
        ...
        <div >
            <div class="titleBg">等待质量评查<div style="font-size: 20px;line-height: 20px;margin-top: -25px;">统计结果为本人管理职责内所有案件</div></div>
            <div class="block">
  ...
  export default {
      ...
      methods: {
          ...
          getNumBage(){
                ...
                params.append('cout_for','getGeRenNotConfirm');
          ...
          getDataList(){
                ...
                self.$axios({
                    method: 'post',
                    url: '/cases/cases/getGeRenNotConfirmByPage',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
