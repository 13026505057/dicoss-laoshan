<template>
    <div>
        ...
        <div>
            <el-form style="width:99%;height:50px;margin-top:5px;padding-top:5px;border:1px solid #eee;" ref="form" :model="form" label-width="100px" :inline="true">
              <el-form-item label="货架号:">
                <el-input style="width:200px;" @input="changeValue" clearable ref="inp1" class="inp-1" v-model="form.name1"></el-input>
              </el-form-item>
              <el-form-item label="案卷号:">
                <el-input style="width:200px;" @input="changeValue2" ref="inp2" clearable class="inp-2" v-model="form.name2"></el-input>
              </el-form-item>
              <el-form-item style="margin-left:60px;" label="案卷类型:">
