    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
                ...
                <el-select v-model="orgId" placeholder="请选择单位" v-show="orgId1==370200?true:false">
                  <el-option
        ...
        <el-dialog title="新增案卷" :visible.sync="addNewAnJuan">
          <el-form ref="form" :model="addNewForm" label-width="120px" label-position="left" style="margin-left:20px;">  
            ...
            <el-form-item label="卷号(必填)" style="display: block;">
              <el-input v-model="addNewForm.jh" placeholder="请输入卷号" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item label="被告人/嫌疑人(必填)" style="display: block;">
              <el-input v-model="addNewForm.bgr" placeholder="请输入被告人/嫌疑人" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item label="卷宗类型(必填)" style="display: block;">
              <el-select  v-model="addNewForm.juanzongType" placeholder="请选择" style="width:208px;">
                <el-option
                  v-for="item in juanzongList"
                  :key="item.type_id"
            ...
            <el-form-item label="选择年度(必填)" style="display: block;">
              <el-input v-model="addNewForm.niandu" placeholder="请输入年度 如 2018" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item label="选择期限(必填)" style="display: block;">
              <el-select filterable  v-model="addNewForm.timeType" placeholder="请选择" style="width:208px;">
                <el-option
            ...
            <el-checkbox v-model="print_code"> 同时打印案件条形码</el-checkbox>
            <el-checkbox v-model="print_accept">同时打印收卷回执单</el-checkbox>
          </el-form>          
          <div slot="footer" class="dialog-footer">
            <el-button @click="addNewAnJuan = false">取 消</el-button>
        ...
        <el-dialog title="案卷详情" :visible.sync="printDialog" width="80%">
          <el-table
            ...
            <div style="margin-top: 20px">
                <el-button @click="toggleSelection(exhibits2)">全选</el-button>
                <el-button @click="toggleSelection()">取消全选</el-button>
                <!-- <el-button @click="updateForIns()">确认待入库</el-button> -->
                <el-button @click="updateForChecks()">批量打印回执单</el-button>
            </div> 
            <el-pagination
                small
                background
        ...
        <el-dialog title="卷宗列表" :visible.sync="case_detail_dialogCuobang" width="80%">
          <div class="block" style="background-size:100%;height:100px;">
                
                <el-input clearable style="width:150px;margin-top:10px;" v-model="case_bh_duo" placeholder="统一受案号"></el-input>
                
                <el-input clearable style="width:150px;margin-top:10px;" v-model="xainyiname_duo" placeholder="嫌疑人"></el-input>
                <el-input  style="width:150px;margin-top:10px;" @change="scanDuo" v-model="scanNumDuo" placeholder="扫描条形码"></el-input>
                <el-select clearable style="width: 150px;margin-left: 20px;" v-model="case_type_duo" placeholder="卷宗类型">
                  <el-option
                    v-for="item in juanzongList"
                    :key="item.type_id"
                    :label="item.type_name"
                ...
                <el-button type="warning" style="margin-left: 20px;" @click="searchDuo">查询</el-button>
                <!-- <el-button type="warning" style="margin-left: 20px;" @click="exportClick">导出</el-button> -->
                <!-- <el-button type="warning" style="margin-left: 20px;" @click="printClickForreturn">批量打印回执单</el-button> -->
                
            </div>
          <el-table
              :data="exhibitsCuobang"
              :header-cell-style="{ 'background-color': '#deedf4','color':'#000'}"
              :row-style="rowStyle"
              class="tableClass"
              style="height:600px"
              ...
              <el-table-column
                ...
                >
                <template slot-scope="props">
                  <el-button  type="warning" size="mini" style="margin-left: 20px;" @click="hebing(props.row)">并卷</el-button>
                  <!-- <el-button  type="warning" size="mini" style="margin-left: 20px;" @click="printAgain(props.row)">补打条码</el-button>
                  <el-button  type="warning" size="mini" style="margin-left: 20px;" @click="printAgain2(props.row)">打印回执单</el-button>
                  <el-button  type="warning" size="mini" style="margin-left: 20px;" @click="zuofeiClick(props.row)">作废</el-button> -->
                </template>
        ...
        <div id="container" style="width: 100%;height: 110%;  float: right;">
          ...
          <div class="tableList">
            <el-tabs type="border-card" v-model="activeName" @tab-click="tabClick">
                ...
                <span style="font-size:19px;" slot="label"><i class="el-icon-date"></i>
                 ...
                 <el-table
                  ...
                  <el-table-column
                    label="交卷日期"
                    align="center"
                    prop="dangan_accept_time"
                    >
                  </el-table-column>
                  <el-table-column
                    label="交卷天数"
                    align="center"
                    prop="dangan_accept_day"
                    >
                  </el-table-column>
                  <el-table-column
                    label="操作"
                    ...
                    <template slot-scope="props">
                      ...
                      <!-- <el-button  type="warning" size="mini" style="margin-left: 0px;" @click="cuobanggenggai(props.row)">多案并案</el-button> -->
              ...
              <el-tab-pane name="tabName10" class="tabClass">
                <span style="font-size:19px;" slot="label"><i class="el-icon-date"></i>
                  自侦
                  <el-badge :value="num10" :hidden="num10==0?true:false" :max="9999" class="badgeClass"> 
                  </el-badge>
                </span>
                <el-table
                  ref="multipleTable8"
              ...
              <el-tab-pane name="tabName11" class="tabClass">
                <span style="font-size:19px;" slot="label"><i class="el-icon-date"></i>
                  侦检业务
                  <el-badge :value="num11" :hidden="num11==0?true:false" :max="9999" class="badgeClass"> 
                  </el-badge>
                </span>
                <el-table
                  ref="multipleTable8"
              ...
              <el-tab-pane name="tabName12" class="tabClass">
                <span style="font-size:19px;" slot="label"><i class="el-icon-date"></i>
                  申诉
                  <el-badge :value="num12" :hidden="num12==0?true:false" :max="9999" class="badgeClass"> 
                  </el-badge>
                </span>
                <el-table
                  ref="multipleTable8"
  ...
  export default {
      data: function(){
          return {
              ...
              case_detail_dialogCuobang:false,
              case_number:'',
              options4: [],
              case_name: [],
              list: [],
      ...
      mounted() {
        var self = this;
          ...
          // var s3 = day2.getHours()+":" + (day2.getMinutes()) + ":" + day2.getSeconds();
          // console.log(s3)
      ...
      methods: {
          hebing(row){
                  ...
                  self.yigui_case_id = row.case_id;
                  params.append('weigui_case_id',self.weigui_case_id);
                  params.append('yigui_case_id',self.yigui_case_id);
                  self.$axios({
                      method: 'post',
                      url: '/exhibit/exhibit/isAddCase',
                      data: params,
          ...
          scanDuo(val){
                  ...
                  self.exhibitsCuobang = [];
                  params.append('code',val);
                  params.append('exhibit_type',self.case_type_duo);
                  self.$axios({
                      method: 'post',
                      ...
                      if(data.data.code==0){
                        self.scanNumDuo = '';
                          if(data.data.data.type=="exhibit"){
                              self.exhibitsCuobang.push(data.data.data.cases);
                              // console.log(self.exhibitsCuobang)
          ...
          cuobanggenggai(data){
            ...
            // console.log(data)
            this.weigui_case_id = data.case_id;
            this.case_bh_duo = data.case_bh;
            this.case_detail_dialogCuobang = true;
            this.getDuoData()
          },
          getDuoData(data){
                const self = this;
                ...
                var params = new URLSearchParams();
                var token = localStorage.getItem('auth');
                // self.case_bh_duo = data.case_bh;
                params.append('case_bh',self.case_bh_duo);
                params.append('case_name',self.xainyiname_duo);
                ...
                self.$axios({
                    ...
                    if(data.data.code==0){
                        self.exhibitsCuobang = data.data.data.list;
          ...
          printClickForreturn(){
            ...
            self.$axios({
                method: 'post',
                url: '/exhibit/exhibit/getTodayByPage',
                data: params,
                headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
             }).then(function(data){
                
                if(data.data.code==0){
                    self.exhibits2 = data.data.data.list;
          ...
          updateForChecks(){
                ...
                for(var i = 0; i < self.multipleSelection.length; i++){
                  ids.push(self.multipleSelection[i].exhibit_id)
                }
                params.append('print_id',localStorage.getItem('printId'));
                params.append('exhibit_ids',ids.join(','));
                self.$axios({
                    method: 'post',
                    url: '/exhibit/exhibit/printTodayExhibits',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
          ...
          toggleSelection(rows) {
            console.log(rows)
            var self = this
            console.log(self.$refs.multipleTable99)
            if (rows) {
              rows.forEach(row => {
                this.$refs.multipleTable99.toggleRowSelection(row);
               
              });
            } else {
              this.$refs.multipleTable99.clearSelection();
          ...
          addNewJuanzong(){
                ...
                params.append('case_id',self.case_id_count);
                params.append('nd',self.addNewForm.niandu);
                params.append('exhibit_type',self.addNewForm.juanzongType);
                params.append('bgqx',self.addNewForm.timeType);
                params.append('dh',self.addNewForm.dh);
                params.append('jh',self.addNewForm.jh);
                params.append('bgr',self.addNewForm.bgr);
                if(self.print_code){
                    params.append('print_code','1');
                }
                if(self.print_accept){
                    params.append('print_accept','1');
                }
          ...
          printAgain2(res){
                ...
                self.$axios({
                    method: 'post',
                    url: '/exhibit/exhibit/printAcceptReturn',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
          ...
          printClick(res){
            this.case_id_count = res.case_id;
            this.addNewAnJuan = true;
            this.addNewForm = {
                juanzongType:'',
                timeType:'',
                niandu:''
          ...
          getNumBage(){
                ...
                self.$axios({
                    ...
                    if(data.data.code==0){
                       ...
                       self.num10 = data.data.data._50;
                       self.num11 = data.data.data._51;
                       self.num12 = data.data.data._52;
          ...
          getDataList(){
                ...
                case 'tabName9':
                  ...
                  break;
                case 'tabName10':
                  params.append('case_type_id','50');
                  break;
                case 'tabName11':
                  params.append('case_type_id','51');
                  break;
                case 'tabName12':
                  params.append('case_type_id','52');
                  break;
                default:
                ...
                self.$axios({
                    method: 'post',
                    url: '/cases/cases/getDangAnWeiGui',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
