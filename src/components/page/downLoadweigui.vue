    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
                ...
                <el-button type="warning" style="margin-left: 30px;" @click="searchClick">下 载</el-button>
  ...
  export default {
      ...
      methods: {
          ...
          searchClick(){
              ...
              params.append('time',self.timeYear);
              ...
              self.$axios({
                  method: 'post',
                  url: 'http://192.168.2.99:8080/dossier/cases/cases/getNotAcceptCountByUser',
                  data: params,
                  ...
                  if(data.data.code==0){
                    ...
                    const blob = new Blob([data2], {type: "text/plain;charset=utf-8"})
