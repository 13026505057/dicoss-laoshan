<template>
    <div>
        ...
        <div >
            <div class="titleBg">整改中案件<div style="font-size: 20px;line-height: 20px;margin-top: -25px;"></div></div>
            <div class="block">
                ...
                <!-- <el-select style="width: 180px;margin-left: 20px;" v-model="caseType" placeholder="请选择案件类型">
                  <el-option
  ...
  export default {
      ...
      methods: {
          ...
          getDataList(){
                ...
                params.append('case_take_user_id',userId);
                ...
                self.$axios({
                    method: 'post',
                    url: '/caseRefuseHistoryGetByPage',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
