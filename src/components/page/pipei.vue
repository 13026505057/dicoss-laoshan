<template>
    <div>
        ...
        <div >
            <div class="titleBg">历史案卷人工匹配</div>
        ...
        <div id="container" style="width: 100%;height: 110%;  float: right;">
          ...
          <div class="leftBox">
            <div class="block" style="background-size: 200% 40%;">
                ...
                <!-- 关键词联想组建 -->
                <el-input clearable  style="width:170px;" v-model="case_name" placeholder="请输入卷宗关键字"></el-input>
                <!-- <el-select
                  v-model="case_name"
                  clearable
                  style="width: 150px;margin-left: 10px;"
          ...
          <div class="rightBox">
            <div class="topBox">
              <div class="tableList" style="height: 50%;background-image: url(../../../static/img/guanliananjianxinxi.jpg)!important">
                <el-table
                    height='255'
                    :data="caseList2"
                    :header-cell-style="{ 'background-color': '#deedf4','color':'#000'}"
                    ...
                    <el-table-column
                      ...
                      >
                      <template slot-scope="props">
                        <el-button  type="warning" size="mini" style="margin-left: 0px;" @click="bangdingClick(props.row)">绑定</el-button>
                        <!-- <el-button  type="warning" size="mini" style="margin-left: 20px;" @click="printClick(props.row)">新增条码</el-button> -->
                      </template>
                    </el-table-column>
                  </el-table> 
            ...
            <div class="bottomBox">
              <div class="block" style="background-image: url(../../../static/img/zizhuchaxun.jpg)!important;background-size: 200% 40%;">
  ...
  export default {
      ...
      methods: {
          ...
          getDataList3(val){
                ...
                params.append('bmsah',self.case_number2);
                // params.append('stock_status','out');
                // params.append('tongyi_status','');
                ...
                self.$axios({
                    method: 'post',
                    url: '/cases/cases/getLikeCases',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
                    
                    if(data.data.code==0){
                        self.caseList3 = data.data.data;
                        // self.total = data.data.data.total;
                    }else{
                      self.$response(data,self);
                    }
